...
public class ChatBubbleEntity implements Serializable {
    ...
    @Builder
    protected ChatBubbleEntity(Long id, String chatroomId, Long sender, Long receiver, String message, Instant createdAt) {
        this.id = id;
    ...
    public static ChatBubbleEntity fromDomain(ChatBubble bubble) {
        return ChatBubbleEntity.builder()
                .id(bubble.getId())
