...
public class ChatroomController {
    ...
    public GenericResponse<ChatroomDetails> getChatroomInfo(@PathVariable String chatroomId, @Login MemberDetails loginMember) throws ExistMemberIdException, ExistChatRoomException, NotChatroomMemberException {
    ...
    public GenericResponse<ChatroomDetails> getChatroomInfo(@PathVariable long itemId, @Login MemberDetails loginMember) throws ExistMemberIdException, ExistItemException, NotChatroomMemberException {
    ...
    @PostMapping
    public GenericResponse<String> createChatRoom(@RequestBody ChatItem chatItem, @Login MemberDetails loginMember) throws ExistMemberIdException, ExistItemException, ExistChatRoomException, BuyerException {
    ...
    @GetMapping
    public GenericResponse<ChatroomList> getChatroomList(ChatItem chatItem, @Login MemberDetails loginMember) throws ExistMemberIdException, ExistItemException {
    ...
    public GenericResponse<String> exitChatroom(@PathVariable String chatId, @Login MemberDetails loginMember) throws ExistMemberIdException, ExistChatRoomException, NotChatroomMemberException {
