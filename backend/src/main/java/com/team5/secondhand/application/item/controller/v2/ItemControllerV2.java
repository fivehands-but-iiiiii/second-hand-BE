...
public class ItemControllerV2 {
    ...
    @GetMapping
    public GenericResponse<ItemsResponse> getItemList(ItemsRequest itemsRequest, @Logined(required = false) MemberDetails loginMember) throws NotValidRegionException {
